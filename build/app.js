...
const product_route_1 = require("./api/routes/product_route");
const product_service_1 = __importDefault(require("./api/services/product_service"));
const bill_route_1 = require("./api/routes/bill_route");
const bill_service_1 = __importDefault(require("./api/services/bill_service"));
...
(0, product_route_1.productroute)(router, new product_service_1.default());
(0, bill_route_1.billrouter)(router, new bill_service_1.default());
exports.default = app;
