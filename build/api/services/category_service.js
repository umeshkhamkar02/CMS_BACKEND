        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const data = new Promise((resolve, reject) => {
                    let sqlResp = {};
                    db_connection_1.default.query(query, [ReqObj.name], (error, result) => {
                        if (error) {
    ...
    updateCategory(ReqObj) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const data = new Promise((resolve, reject) => {
                    let sqlResp = {};
                    db_connection_1.default.query(query, [ReqObj.id, ReqObj.name], (error, result) => {
                        if (error) {
                            sqlResp.isSuccess = false;
                            sqlResp.message = error.message;
                        }
...
exports.default = category_service;
